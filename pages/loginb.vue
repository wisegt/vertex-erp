...
async function login() {
  ...
  try {
    ...
    if (user) {
      ...
      // ⚠️ NO llamar ability.update() aquí - causa bucle infinito con el middleware
      // El middleware ACL leerá las abilities de las cookies automáticamente

      console.log('[simple-login] Usuario guardado en cookies')
    }
